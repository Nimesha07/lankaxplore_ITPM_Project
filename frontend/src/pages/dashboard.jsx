  ...
  const prevImage = () => {
    if (
      ...
      setCurrentImageIndex((prev) =>
        prev === 0
          ? selectedPackage.days[currentDay].highlights.length - 1
          : prev - 1
      );
    }
  };
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-center mb-4">
                  <div className="flex mr-2">{renderStars(pkg.rating)}</div>
                  <span className="text-lg font-semibold">{pkg.rating}</span>
                </div>
                <div className="flex justify-center">
                  <button
                    onClick={() => handleMoreInformation(pkg._id)}
                ...
                <div className="mb-4">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <p className="font-bold">
                      Price: USD ${selectedPackage.price}
                    </p>
                ...
                <div className="day-details">
                  ...
                  {selectedPackage.days[currentDay].highlights.length > 0 && (
                    <div className="position-relative mb-4">
                      <img
                        src={
                          selectedPackage.days[currentDay].highlights[
                            currentImageIndex
                          ]
                        }
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="mb-3">
                        ...
                        <ul className="list-unstyled">
                          {selectedPackage.days[currentDay].activities
                            .split(",")
                            .map((activity, index) => (
                              <li
                                key={index}
